// Knight Online FX — Alpha Blend Shader
...
//   D3DRS_SRCBLEND  = D3DBLEND_SRCALPHA (5) → Blend SrcAlpha OneMinusSrcAlpha
...
// Standart alpha blending — texture alpha ile şeffaflık
Shader "KO/FX/AlphaBlend"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            // Open-KO birebir: D3DBLEND_SRCALPHA + D3DBLEND_INVSRCALPHA
            Blend SrcAlpha OneMinusSrcAlpha

            // C++ alpha blend'de ZWrite kapalı — transparent sıralama doğru çalışsın
            ZWrite Off
